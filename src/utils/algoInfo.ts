const primesInfo = [
  [
    ...
    },
    {
      ...
      colour: 'error',
      icon: 'mdi-numeric-2',
      text: 'For each element in the outer loop, an inner loop is initialized. The inner loop runs through every number lower than the outler loop number that triggered it. If the outer loop number is divisible by any of these numbers then it is not a prime number.'
    },
    {
      id: 3,
      colour: 'warning',
  ...
  [
    ...
    },
    {
      ...
      colour: 'error',
      icon: 'mdi-numeric-2',
      text: 'For each element in the outer loop, an inner loop is initialized.'
    },
    {
      id: 3,
      colour: 'purple',
    ...
    },
    {
      ...
      text: "This is because any number greater than a numbers square root cannot be a factor of that number (if you multiply any number greater than a numbers square root by itself you'll get a number greater than the number in question)"
    }
  ],
  [
    {
...
const multiplesInfo = [
  [
    ...
    },
    {
      ...
      colour: 'orange',
      icon: 'mdi-numeric-2',
      text: "Then runs the JS 'filter' array method which loops over the whole array. For each element a callback function runs that returns a boolean true/false. The 'true' elements are added to the new array."
    },
    {
      id: 3,
      colour: 'success',
